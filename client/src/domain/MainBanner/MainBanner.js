...
function Greetings() {
  return (
    <> 
      ...
      Learning through creation and play, Codercademy is the first and only Doyobi science & coding school in the Philippines with courses based on the highly successful Saturday Kids curricula, Singapore’s largest coding school for kids.</p>
    </>
  ) 
}
